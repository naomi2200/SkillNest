                    ...
                    <header class="dashboard-hero">
                        ...
                        <div class="dashboard-hero__content">
                            <div class="dashboard-hero__text">
                                <h1>@yield('dashboard-title', 'Panel')</h1>
                                <p>@yield('dashboard-subtitle', 'Explora y gestiona todo tu ecosistema SkillNest')</p>
                            </div>
                            <div class="dashboard-hero__meta">
                                <div>
                                    <p class="font-semibold text-slate-800">{{ auth()->user()->name ?? 'Usuario SkillNest' }}</p>
                                    <p class="text-sm text-slate-500">{{ auth()->user()->email ?? 'user@skillnest.com' }}</p>
                                </div>
