    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center">
            ...
            <div class="hidden lg:flex items-center space-x-8">
                ...
                <a href="{{ route('mentor-market.index') }}" class="nav-link">
                    <i class="fas fa-users mr-2"></i>Mentorías
                </a>
                <a href="{{ url('/mentorias/create') }}" class="nav-link">
            ...
            <div class="hidden lg:flex items-center space-x-4">
                @auth
                    <a href="{{ route('dashboard') }}" class="text-gray-600 hover:text-purple-600 font-medium transition-colors">
                ...
                @else
                    <a href="{{ route('login') }}" class="text-gray-600 hover:text-purple-600 font-medium transition-colors">
                        <i class="fas fa-sign-in-alt mr-2"></i>Ingresar
                    </a>
                    <a href="{{ route('register') }}" class="btn-primary flex items-center">
        ...
        <div x-show="mobileMenuOpen"
            ...
            <div class="flex flex-col space-y-3">
                <a href="{{ url('/cursos') }}" class="flex items-center text-gray-700 hover:text-purple-600 py-2 px-3 rounded-lg hover:bg-gray-50">
                    <i class="fas fa-graduation-cap mr-3"></i>Cursos
                </a>
                <a href="{{ route('mentor-market.index') }}" class="flex items-center text-gray-700 hover:text-purple-600 py-2 px-3 rounded-lg hover:bg-gray-50">
                    <i class="fas fa-users mr-3"></i>Mentorías
                </a>
                <a href="{{ url('/mentorias/create') }}" class="flex items-center text-gray-700 hover:text-purple-600 py-2 px-3 rounded-lg hover:bg-gray-50">
                    <i class="fas fa-chalkboard-teacher mr-3"></i>Ser Mentor
                </a>
                <a href="{{ route('home') }}" class="flex items-center text-gray-700 hover:text-purple-600 py-2 px-3 rounded-lg hover:bg-gray-50">
                    <i class="fas fa-briefcase mr-3"></i>Empresas
                </a>
                <div class="pt-3 border-t border-gray-200 space-y-3">
                    @auth
                        <a href="{{ route('dashboard') }}" class="flex items-center text-gray-700 hover:text-purple-600 py-2 px-3 rounded-lg hover:bg-gray-50">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="flex items-center text-gray-700 hover:text-purple-600 py-2 px-3 rounded-lg hover:bg-gray-50">
                            <i class="fas fa-sign-in-alt mr-3"></i>Ingresar
                        </a>
                        <a href="{{ route('register') }}" class="btn-primary text-center flex items-center justify-center">
                            <i class="fas fa-user-plus mr-2"></i>Crear Cuenta
                        </a>
                    @endauth
                </div>
