        ...
        <div class="mentor-market__container">
            ...
            <section class="filter-section">
                ...
                <div class="filter-actions">
                    ...
                    <a href="{{ route('mentor-market.index') }}" class="btn btn-secondary">Limpiar</a>
                </div>
            </section>
                ...
                @forelse($publicMentorias as $mentoria)
                    ...
                    <article class="mentor-card">
                        <div class="mentor-header">
                            ...
                            <div>
                                <h2>{{ $mentorUser->name ?? 'Mentor SkillNest' }}</h2>
                        ...
                        <div class="mentor-details">
                            <div class="detail-item">
                                ...
                                <span class="detail-value">{{ $mentoria->especialidad ?? $mentorProfile->profesion ?? 'Generalista' }}</span>
                            </div>
                            @if($mentorProfile?->nivel_experiencia)
                                <div class="detail-item">
                                    <span class="detail-label">Nivel:</span>
                                    <span class="detail-value">{{ $experienceLevels[$mentorProfile->nivel_experiencia] ?? ucfirst($mentorProfile->nivel_experiencia) }}</span>
                                </div>
                            @endif
                            @if($mentorProfile?->categorias)
                                <div class="detail-item">
                                    <span class="detail-label">Categorías:</span>
                                    <span class="detail-value">{{ $mentorProfile->categorias }}</span>
                                </div>
                            @endif
                            <div class="detail-item">
                                <span class="detail-label">Precio:</span>
                                <span class="detail-value price">S/ {{ number_format($price ?? 0, 2) }}</span>
                            </div>
                            <div class="detail-item">
                                <span class="detail-label">Duración:</span>
                                <span class="detail-value">{{ $mentoria->duracion_minutos }} min</span>
                            </div>
                            <div class="detail-item">
                                <span class="detail-label">Modalidad:</span>
                                <span class="detail-value">{{ ucfirst($mentoria->modalidad) }}</span>
                            </div>
                        </div>
