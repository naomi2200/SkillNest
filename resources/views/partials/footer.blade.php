        ...
        <div class="footer-top">
            ...
            <div class="footer-column">
                ...
                <ul class="footer-links">
                    <li><a href="{{ url('/cursos') }}">Explorar cursos</a></li>
                    <li><a href="{{ url('/mentor-market') }}">Buscar mentores</a></li>
                    <li><a href="{{ url('/mentorias/create') }}">Convi&eacute;rtete en mentor</a></li>
