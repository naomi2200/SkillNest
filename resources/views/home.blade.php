...
<div class="home-page">
    <section class="home-hero-grid">
        <div class="home-hero-card">
            ...
            <form class="home-hero-form" action="{{ route('home') }}" method="GET">
            ...
            <div class="home-hero-buttons">
                <a class="home-btn-primary" href="{{ url('/cursos') }}">Ver cursos publicados</a>
                <a class="home-btn-secondary" href="{{ route('mentor-market.index') }}">Ver mentorías</a>
            </div>
    ...
    <section class="home-section">
        <div class="home-section-header">
            ...
            <a class="home-btn-secondary" href="{{ url('/cursos') }}">Ver todos &rarr;</a>
        </div>
            ...
            @foreach ($courses as $course)
                <article class="home-course-card">
                    ...
                    <div class="home-course-content">
                        <span class="home-course-category">{{ $course['category'] }}</span>
                        <div>
                            <h3 class="home-course-title">{{ $course['title'] }}</h3>
                            <p class="home-course-mentor">por {{ $course['mentor'] }}</p>
                        </div>
                        ...
                        <div class="home-course-footer">
                            <p class="home-course-price">{{ $course['price'] }}</p>
                            <a class="home-btn-primary" href="{{ url('/cursos') }}">Ver más &rarr;</a>
                        </div>
                    </div>
                </article>
            @endforeach
    ...
    <section class="home-section">
        <div class="home-section-header">
            ...
            <a class="home-btn-secondary" href="{{ route('mentor-market.index') }}">Ver todos &rarr;</a>
        </div>
        <div class="home-mentor-grid">
            @foreach ($mentors as $mentor)
                <article class="home-mentor-card">
                    <div class="home-mentor-avatar">{{ $mentor['initial'] }}</div>
                    <h3>{{ $mentor['name'] }}</h3>
                    <p>{{ $mentor['role'] }}</p>
                    ...
                    <p class="home-mentor-price">{{ $mentor['price'] }}</p>
                    <a class="home-btn-primary" href="{{ route('mentor-market.index') }}">Ver perfil &rarr;</a>
                </article>
            @endforeach
        </div>
    </section>
    ...
    <section class="home-cta">
        <div class="home-cta-grid">
            <div class="home-cta-block">
                ...
                <a class="home-btn-secondary" href="{{ route('register') }}">Explorar cursos &rarr;</a>
            </div>
            <div class="home-cta-block">
                ...
                <a class="home-btn-secondary" href="{{ route('register') }}">Comenzar ahora &rarr;</a>
            </div>
        </div>
    </section>
</div>
