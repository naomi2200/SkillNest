...
@section('content')
    @php
        $categories = [
            ['name' => 'Programaci?n', 'courses' => 234, 'icon' => ''],
            ['name' => 'Dise?o', 'courses' => 156, 'icon' => ''],
            ['name' => 'Marketing', 'courses' => 98, 'icon' => ''],
            ['name' => 'Negocios', 'courses' => 145, 'icon' => ''],
            ['name' => 'Fotograf?a', 'courses' => 67, 'icon' => ''],
            ['name' => 'M?sica', 'courses' => 43, 'icon' => ''],
        ];
        ...
        $courses = [
            ...
            [
                'title' => 'Dise?o UX/UI: Crea Interfaces Incre?bles',
                'mentor' => 'Ana Garc?a',
                'category' => 'Dise?o',
                'price' => 129,
                'rating' => 4.7,
        ...
        $mentors = [
            ['name' => 'Carlos G?mez', 'title' => 'Senior Laravel Developer', 'rating' => 4.9, 'sessions' => 125, 'price' => 80, 'available' => true],
            ['name' => 'Mar?a Lpez', 'title' => 'Frontend Expert', 'rating' => 4.8, 'sessions' => 98, 'price' => 70, 'available' => true],
            ['name' => 'Ana Garc?a', 'title' => 'UX/UI Designer', 'rating' => 5.0, 'sessions' => 156, 'price' => 90, 'available' => false],
            ['name' => 'Jos? Ram?rez', 'title' => 'Marketing Strategist', 'rating' => 4.7, 'sessions' => 89, 'price' => 75, 'available' => true],
        ];
    @endphp
    ...
    <div class="mx-auto flex max-w-6xl flex-col gap-16 py-12">
        ...
        <section class="rounded-[32px] border border-slate-100 bg-white/90 p-10 shadow-card">
            <div class="grid gap-10 lg:grid-cols-2">
                <div class="space-y-8">
                    ...
                    <p class="text-lg text-slate-500">Accede a ms de 500 cursos y conecta con mentores profesionales.</p>
                    ...
                    <form action="{{ route('cursos.index') }}" method="GET" class="rounded-full border border-slate-200 bg-white/80 p-2 shadow-sm">
                        <div class="flex items-center gap-3 px-2">
                            ...
                            <input type="text" name="q" placeholder="Qu quieres aprender hoy?" class="flex-1 border-0 bg-transparent focus:outline-none">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <a href="{{ route('mentor-market.index') }}" class="btn-secondary rounded-full px-6">Ver mentoras</a>
                    </div>
                    ...
                    <div class="grid gap-6 sm:grid-cols-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-500">Valoracin</p>
                        </div>
                        <div>
        ...
        <section class="space-y-8">
            <div class="flex items-center justify-between">
                <h2 class="text-3xl font-bold text-secondary">Explora por categora</h2>
            ...
            <div class="grid gap-5 md:grid-cols-3 lg:grid-cols-6">
                @foreach($categories as $category)
                    <article class="rounded-3xl border border-slate-100 bg-white p-5 text-center shadow-card transition hover:-translate-y-1 hover:shadow-xl">
                        <div class="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-primary/10 text-2xl">
                            {{ $category['icon'] }}
                        </div>
        ...
        <section class="space-y-8">
            <div class="flex items-center justify-between">
                <h2 class="text-3xl font-bold text-secondary">Cursos ms populares</h2>
                <a href="{{ route('cursos.index') }}" class="btn-secondary rounded-full px-5">Ver todos</a>
            </div>
                    ...
                    <article class="rounded-[28px] border border-slate-100 bg-white shadow-card">
                        ...
                        <div class="space-y-4 p-6">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ route('cursos.index') }}" class="btn-gradient rounded-full px-5">Ver ms</a>
                            </div>
                        </div>
                    </article>
                @endforeach
            ...
            <div class="grid gap-10 md:grid-cols-2">
                <div class="space-y-4">
                    ...
                    <ul class="list-disc space-y-2 pl-5 text-white/80">
                        ...
                        <li>Agenda mentoras personalizadas</li>
                ...
                <div class="space-y-4">
                    <h3 class="text-3xl font-bold">Quieres Ensear?</h3>
                    <ul class="list-disc space-y-2 pl-5 text-white/80">
                        <li>Crea y vende tus cursos</li>
                        <li>Ofrece mentoras 1 a 1</li>
                        <li>Genera ingresos pasivos</li>
                    </ul>
                    <a href="{{ route('register') }}" class="inline-flex rounded-full bg-white px-6 py-3 font-semibold text-secondary">Comenzar a ensear</a>
                </div>
            </div>
        </section>
    </div>
