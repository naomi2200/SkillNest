        ...
        <div class="dashboard-shell">
            <aside class="dashboard-sidebar">
                ...
                <nav class="dashboard-nav">
                    ...
                    <a href="<?php echo e(route('admin.courses.index', ['status' => 'aprobado', 'view' => 'tabla'])); ?>" class="nav-item">
            ...
            <main class="dashboard-main">
                <header class="dashboard-hero">
                    <div class="hero-badge">Hola, <?php echo e(auth()->user()->name); ?></div>
                    ...
                    <div class="hero-actions">
                        <a href="<?php echo e(route('admin.courses.index', ['status' => 'pendiente', 'view' => 'solicitudes'])); ?>" class="btn btn-primary">Ver cursos pendientes</a>
                        <a href="<?php echo e(route('admin.courses.index', ['status' => 'aprobado', 'view' => 'tabla'])); ?>" class="btn btn-secondary">Gestionar cursos</a>
                    </div>
                </header>

                <div class="stats-grid">
                    <div class="stat-card">
                        <div class="stat-value"><?php echo e(number_format($stats['courses_active'] ?? 0)); ?></div>
                        <div class="stat-label">Cursos activos</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-value"><?php echo e(number_format($stats['courses_pending'] ?? 0)); ?></div>
                        <div class="stat-label">En revisión</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-value"><?php echo e(number_format($stats['courses_drafts'] ?? 0)); ?></div>
                        <div class="stat-label">Borradores</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-value"><?php echo e(number_format($stats['courses_rejected'] ?? 0)); ?></div>
                        <div class="stat-label">Rechazados</div>
                    </div>
                </div>

                <div class="content-section">
                    <h3 class="section-title">Cursos pendientes (<?php echo e(($pendingCourses ?? collect())->count()); ?>)</h3>
                    <?php $__empty_1 = true; $__currentLoopData = $pendingCourses ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 mb-3">
                            ...
                            <p class="text-xs text-gray-500">Mentor: <?php echo e($course->mentor->name ?? 'Sin asignar'); ?></p>
                        </div>
                ...
                <div class="content-section">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $recentUsers ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recentUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex justify-between rounded-2xl border border-gray-200 bg-gray-50 px-4 py-3 mb-2">
                            <span class="font-semibold text-secondary"><?php echo e($recentUser->name); ?></span>
                            <span class="text-sm text-gray-500"><?php echo e(ucfirst($recentUser->role ?? 'usuario')); ?></span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillnest-backend\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>