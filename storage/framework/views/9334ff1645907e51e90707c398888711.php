<?php $__env->startSection('dashboard-title', 'Curso: ' . $course->title); ?>
...
<?php $__env->startSection('dashboard-content'); ?>
    <div class="space-y-8">
        <div class="rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-card">
        ...
        <div class="grid gap-6 lg:grid-cols-2">
            <div class="rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-card space-y-3">
            ...
            <div class="rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-card space-y-4">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillnest-backend\resources\views/admin/courses/show.blade.php ENDPATH**/ ?>