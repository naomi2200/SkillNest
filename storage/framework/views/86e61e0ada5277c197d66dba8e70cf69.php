...
<?php $__env->startPush('styles'); ?>
    <style>
        ...
        body {
            ...
            background: linear-gradient(140deg, #f0f9ff 0%, #ecfeff 45%, #e0f2fe 100%);
            min-height: 100vh;
        }
        body::before {
            content: "";
            ...
            inset: 0;
            background:
                radial-gradient(circle at 12% 30%, rgba(14,165,233,0.12) 0%, transparent 45%),
                radial-gradient(circle at 85% 80%, rgba(45,212,191,0.15) 0%, transparent 55%),
        ...
        .stat-card:hover { transform: translateY(-4px); box-shadow: 0 18px 32px rgba(14,165,233,0.15); }
        .stat-label { font-size: 12px; text-transform: uppercase; letter-spacing: 0.12em; color: #94a3b8; font-weight: 600; }
        .stat-value { font-size: 36px; font-weight: 900; margin-top: 8px; background: linear-gradient(135deg, #0ea5e9, #34d399); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
        .stat-description { font-size: 13px; color: #6b7280; margin-top: 8px; }

        .content-card { background: #fff; border-radius: 26px; padding: 28px; border: 1px solid rgba(226,232,240,0.8); box-shadow: 0 12px 30px rgba(15,118,110,0.08); }
