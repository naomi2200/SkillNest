        ...
        <div class="h-full space-y-4 p-4">
            <div class="rounded-3xl bg-white p-5 shadow-card">
                ...
                <nav class="mt-5 space-y-2 text-sm font-medium text-slate-500">
                    ...
                    <a href="<?php echo e(route('mentor.courses.create')); ?>"
                       class="flex items-center gap-3 rounded-2xl px-3 py-2 transition <?php echo e(request()->routeIs('mentor.courses.create') ? 'bg-primary/10 text-primary' : 'hover:bg-slate-100'); ?>">
                        Crear curso
                    </a>
...
<?php /**PATH C:\PHP\SkillNest\skillNest\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>