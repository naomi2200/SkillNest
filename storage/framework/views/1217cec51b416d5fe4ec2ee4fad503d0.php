...
<?php $__env->startSection('mentor-subtitle', 'Gestiona y organiza todos tus cursos creados'); ?>
...
<?php $__env->startSection('mentor-actions'); ?>
    <div class="mis-cursos-actions">
        <form action="<?php echo e(route('mentor.courses')); ?>" method="GET" class="mis-cursos-search">
    ...
    <div class="mis-cursos-page animate-fade-in-up">
        <section class="mis-cursos-header card-hover">
            ...
            <div class="text-right">
                ...
                <p class="text-3xl font-bold gradient-text"><?php echo e($totalStudents); ?></p>
            </div>
        </section>
        ...
        <section class="mis-cursos-stats">
            <?php $__currentLoopData = $statCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article class="stats-card">
                    <div class="stats-card-icon" style="background: <?php echo e($card['color']); ?>;">
                        <i class="fa-solid <?php echo e($card['icon']); ?>"></i>
                    </div>
                    <div class="stats-card-body">
                        <p class="stats-card-label"><?php echo e($card['label']); ?></p>
                        <p class="stats-card-value" style="color: <?php echo e($card['value_color'] ?? '#1f2937'); ?>;">
                            <?php echo e($card['value']); ?>

                        </p>
                        <?php if(!empty($card['trend'])): ?>
                            <p class="stats-card-trend" style="color: <?php echo e($card['trend_color'] ?? '#94a3b8'); ?>;">
                                <?php if(!empty($card['trend_icon'])): ?>
                                    <i class="fa-solid <?php echo e($card['trend_icon']); ?>"></i>
                                <?php endif; ?>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr data-status="<?php echo e($visibleStatus); ?>" data-course-id="<?php echo e($course->id); ?>">
                            <td>
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500 mt-1"><?php echo e($course->category); ?> • <?php echo e($course->level ?? 'General'); ?></p>
                                        <span class="mis-cursos-badge <?php echo e($reviewBadgeClass); ?> mt-1 inline-flex items-center gap-2">
                                            <i class="fa-solid fa-clipboard-check"></i> <?php echo e($reviewLabel); ?>
                            ...
                            <td>
                                <span class="mis-cursos-badge <?php echo e($badge['class']); ?>">
                            ...
                            <td>
                                <div>
                                    <p class="font-bold text-lg text-gray-800"><?php echo e($studentCount); ?></p>
                            ...
                            <td>
                                <div>
                                    <div class="flex justify-between text-sm text-gray-500 mb-1">
                                        ...
                                        <span class="font-semibold text-purple-600"><?php echo e($progress); ?>%</span>
                                    </div>
                                    <div class="mis-cursos-progress">
                                        <div class="mis-cursos-progress-fill" style="width: <?php echo e($progress); ?>%;"></div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <?php if($rating): ?>
                                    <div class="mis-cursos-rating">
                                        ...
                                        <span class="font-semibold text-gray-800"><?php echo e(number_format($rating, 1)); ?></span>
                                        <span class="text-gray-400 text-sm">(<?php echo e($reviews); ?>)</span>
                                    </div>
                                <?php else: ?>
                            ...
                            <td>
                                <div class="mis-cursos-action-group">
                                    <a href="<?php echo e(route('cursos.editor', $course)); ?>" class="mis-cursos-action-btn" title="Editar curso">
                                        <i class="fa-solid fa-pen"></i>
                                    </a>
                                    <?php if(Route::has('courses.classroom')): ?>
                                        <a href="<?php echo e(route('courses.classroom', $course)); ?>" class="mis-cursos-action-btn" title="Ver aula">
...
<?php echo $__env->make('layouts.mentor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\NADHIRA\Downloads\SkillNest\resources\views/dashboard/mentor/courses.blade.php ENDPATH**/ ?>