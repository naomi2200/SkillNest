<?php $__env->startSection('student-title', 'Dashboard estudiante'); ?>
<?php $__env->startSection('student-subtitle', 'Visualiza tu progreso y proximas mentorias'); ?>
        ...
        <div class="dashboard-container">
            <div class="dashboard-header">
                <div class="user-welcome">
                    <h1 class="font-poppins">Hola, <span class="gradient-text"><?php echo e(auth()->user()->name ?? 'Estudiante'); ?></span>! 👋</h1>
            ...
            <div class="stats-grid">
                <?php $__currentLoopData = $statCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="stat-card">
                        <div class="stat-icon" style="background: <?php echo e($card['color']); ?>;">
                            <i class="fa-solid <?php echo e($card['icon']); ?>"></i>
                        </div>
                        <div class="stat-body">
                            <p class="stat-label"><?php echo e($card['label']); ?></p>
                            <p class="stat-value"><?php echo e($card['value']); ?></p>
                            <?php if(!empty($card['trend'])): ?>
                                <p class="stat-trend"
                                   style="color: <?php echo e($card['trend_color'] ?? '#10b981'); ?>;">
                                    <i class="fa-solid <?php echo e($card['trend_icon'] ?? 'fa-arrow-up'); ?>"></i>
                                    <?php echo e($card['trend']); ?>
                ...
                <div class="dashboard-left">
                    <div class="section-card">
                        <div class="section-header">
                            ...
                            <a href="<?php echo e(route('student.courses')); ?>" class="view-all">Ver todos <i class="fa-solid fa-arrow-right"></i></a>
                        </div>
                                    ...
                                    <div class="course-header">
                                        <div class="course-info">
                                            ...
                                            <div class="course-meta">
                                                <span><i class="fa-solid fa-user"></i> <?php echo e($course['mentor']); ?></span>
                                                <span><i class="fa-solid fa-layer-group"></i> <?php echo e($course['modules']); ?> modulos</span>
                                                <span><i class="fa-solid fa-clock"></i> <?php echo e($course['hours']); ?> horas</span>
                                            </div>
                                        </div>
                                        <div class="course-progress">
                                            <div class="progress-value"><?php echo e($course['progress']); ?>%</div>
                                            <div class="progress-label">Completado</div>
                                        </div>
                                    </div>
                                    <div class="progress-bar">
                                        <div class="progress-fill" style="width: <?php echo e($course['progress']); ?>%; background: <?php echo e($course['color']); ?>;"></div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                ...
                <div class="dashboard-right">
                    <div class="section-card">
                        <div class="section-header">
                            ...
                            <a href="<?php echo e(route('student.mentorias')); ?>" class="view-all">Ver todas <i class="fa-solid fa-arrow-right"></i></a>
                        </div>
                            ...
                            <?php $__currentLoopData = $mentorships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mentorship): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mentorship-card">
                                    <div class="mentorship-header">
                                        <div class="mentor-avatar"><?php echo e($mentorship['avatar']); ?></div>
                                        <div class="mentor-info">
                                            <h4><?php echo e($mentorship['name']); ?></h4>
                                            <div class="mentor-specialty"><?php echo e($mentorship['specialty']); ?></div>
                                        </div>
                                    </div>
                                    <div class="mentorship-details">
                                        <div class="session-time">
                                            <div class="session-date"><?php echo e($mentorship['date']); ?></div>
                                            <div class="session-hour"><?php echo e($mentorship['hour']); ?></div>
                                        </div>
                                        <span class="session-status <?php echo e($mentorship['status'] === 'confirmada' ? 'status-confirmed' : 'status-pending'); ?>">
                                            <?php echo e(ucfirst($mentorship['status'])); ?>
                        ...
                        <div style="display:flex;flex-direction:column;gap:16px;">
                            <?php $__currentLoopData = $upcomingEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div style="display:flex;align-items:center;gap:16px;padding:12px;background:rgba(102,126,234,0.05);border-radius:12px;">
                                    <div style="width:40px;height:40px;border-radius:10px;background:<?php echo e($event['bg']); ?>;display:flex;align-items:center;justify-content:center;color:#fff;">
                                        <i class="fa-solid <?php echo e($event['icon']); ?>"></i>
                                    </div>
                                    <div>
                                        <div style="font-weight:600;color:#1f2937;"><?php echo e($event['title']); ?></div>
                                        <div style="font-size:14px;color:#6b7280;"><?php echo e($event['subtitle']); ?></div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
...
<?php echo $__env->make('layouts.student', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\NADHIRA\Downloads\SkillNest\resources\views/student/dashboard.blade.php ENDPATH**/ ?>