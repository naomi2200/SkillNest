...
<?php $__env->startSection('content'); ?>
    <div class="mx-auto max-w-4xl space-y-6">
        <a href="<?php echo e(route('mentor.public.show', $mentor)); ?>" class="inline-flex items-center text-sm font-semibold text-secondary hover:underline">
            ← Volver al perfil
        </a>
        ...
        <div class="rounded-[32px] border border-slate-100 bg-white/95 p-8 shadow-card">
            <div class="flex flex-wrap items-center gap-4">
                ...
                <div class="flex-1">
                    ...
                    <h1 class="text-3xl font-semibold text-secondary"><?php echo e($mentor->name); ?></h1>
                    <p class="text-sm text-slate-500"><?php echo e($mentoria->especialidad ?? ($profile->profesion ?? 'Generalista')); ?></p>
                </div>
                <div class="text-right">
                    <p class="text-sm text-slate-500"><?php echo e($modalidad); ?></p>
                    <p class="text-2xl font-semibold text-secondary">S/ <?php echo e(number_format($price, 2)); ?></p>
                    <p class="text-xs text-slate-400"><?php echo e($duration); ?> min</p>
                </div>
            </div>
                ...
                <section class="space-y-4">
                    ...
                    <?php if(!auth()->check()): ?>
                        <div class="rounded-2xl border border-slate-200 bg-slate-50/70 p-4">
                            ...
                            <a href="<?php echo e(route('login')); ?>" class="btn-primary mt-3 inline-flex items-center justify-center">Iniciar sesión</a>
                        </div>
                ...
                <aside class="rounded-2xl border border-slate-100 bg-slate-50/70 p-5 text-sm text-slate-600">
                    ...
                    <dl class="mt-4 space-y-3">
                        <div class="flex justify-between">
                            ...
                            <dd class="font-semibold text-secondary">S/ <?php echo e(number_format($price, 2)); ?></dd>
                        </div>

                        <div class="flex justify-between">
                            <dt>Servicio SkillNest (5%)</dt>
                            <dd class="font-semibold text-red-500">- S/ <?php echo e(number_format($serviceFee, 2)); ?></dd>
                        </div>

                        <div class="flex justify-between">
                            <dt>Duración</dt>
                            <dd class="font-semibold text-secondary"><?php echo e($duration); ?> minutos</dd>
                        </div>
                        <div class="flex justify-between">
                            <dt>Modalidad</dt>
                            <dd class="font-semibold text-secondary"><?php echo e($modalidad); ?></dd>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\NADHIRA\Downloads\SkillNest\resources\views/mentor-market/book.blade.php ENDPATH**/ ?>