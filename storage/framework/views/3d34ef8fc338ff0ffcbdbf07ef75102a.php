                    ...
                    <div class="animate-fade-in-up">
                        ...
                        <div class="flex flex-wrap gap-6 mb-8">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="text-2xl font-bold text-gray-900"><?php echo e($statsCursos); ?></div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="text-2xl font-bold text-gray-900"><?php echo e($statsEstudiantes); ?></div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="text-2xl font-bold text-gray-900"><?php echo e($statsRating); ?></div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <a href="<?php echo e(Route::has('cursos.index') ? route('cursos.index') : url('/cursos')); ?>" class="btn-primary flex items-center justify-center">
                                <i class="fas fa-play-circle mr-3"></i>Explorar Cursos
                            </a>
                            <a href="<?php echo e(route('mentor-market.index')); ?>" class="border-2 border-gray-300 text-gray-700 font-medium px-8 py-3 rounded-xl text-center hover:border-purple-500 hover:text-purple-600 transition-all flex items-center justify-center">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                    <a href="<?php echo e($categoriaUrl); ?>" class="category-card card-hover">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-2"><?php echo e($categoriaNombre); ?></h3>
                        <p class="text-gray-600 mb-4"><?php echo e($categoriaDescripcion); ?></p>
            ...
            <div class="text-center mt-12">
                <a href="<?php echo e(Route::has('cursos.index') ? route('cursos.index') : url('/cursos')); ?>" class="inline-flex items-center text-lg font-medium text-purple-600 hover:text-purple-700">
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-12">
                ...
                <a href="<?php echo e(Route::has('cursos.index') ? route('cursos.index') : url('/cursos')); ?>" class="mt-4 sm:mt-0 inline-flex items-center text-purple-600 hover:text-purple-700 font-medium">
                ...
                <?php $__currentLoopData = $cursos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $curso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="course-card card-hover shadow-soft">
                        <div class="relative h-48 overflow-hidden">
                            <img src="<?php echo e($cursoImagen); ?>" alt="<?php echo e($cursoTitulo); ?>" class="w-full h-full object-cover">
                            <div class="absolute top-4 right-4">
                                <span class="glass-dark text-white text-xs font-bold px-3 py-1 rounded-full"><?php echo e(strtoupper($cursoBadge)); ?></span>
                            </div>
                            <div class="absolute bottom-4 left-4">
                                <div class="flex items-center text-white">
                                    <i class="fas fa-star text-yellow-300 mr-1"></i>
                                    <span class="font-bold"><?php echo e($cursoRating); ?></span>
                        ...
                        <div class="p-6">
                            <div class="flex items-center justify-between mb-3">
                                <span class="text-sm font-medium text-purple-600"><?php echo e($categoriaCurso); ?></span>
                                <?php if($courseDuration): ?>
                                    <span class="text-sm text-gray-500"><?php echo e($courseDuration); ?></span>
                                <?php endif; ?>
                            </div>
                            <h3 class="text-xl font-bold text-gray-900 mb-3"><?php echo e($cursoTitulo); ?></h3>
                            <p class="text-gray-600 mb-4"><?php echo e($cursoDescripcion); ?></p>
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 rounded-full bg-gradient-to-br from-blue-100 to-cyan-100 flex items-center justify-center mr-3">
                                        <span class="text-blue-600 font-bold"><?php echo e(\Illuminate\Support\Str::of($cursoMentor)->substr(0, 2)); ?></span>
                                    </div>
                                    <span class="font-medium text-gray-700"><?php echo e($cursoMentor); ?></span>
                                </div>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="text-2xl font-bold text-gray-900"><?php echo e($cursoPrecioTexto); ?></div>
                                <a href="<?php echo e($cursoShowUrl); ?>" class="text-purple-600 font-medium hover:text-purple-700">
                                    Ver curso
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <?php $__currentLoopData = $mentores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mentor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div class="mentor-card card-hover">
                        <div class="relative inline-block mb-6">
                            <div class="w-20 h-20 rounded-full <?php echo e($gradientClass); ?> flex items-center justify-center mx-auto">
                                <div class="w-18 h-18 rounded-full bg-white flex items-center justify-center">
                                    <span class="text-xl font-bold gradient-text"><?php echo e($mentorIniciales); ?></span>
                                </div>
                            </div>
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-1"><?php echo e($mentorNombre); ?></h3>
                        <p class="text-purple-600 font-medium mb-4"><?php echo e($mentorRol); ?></p>
                        <div class="flex items-center justify-center mb-4">
                            <div class="flex items-center text-yellow-500">
                                <i class="fas fa-star"></i>
                                <span class="ml-2 font-medium text-gray-700"><?php echo e($mentorRating); ?></span>
                            </div>
                        </div>
                        <div class="text-gray-600 mb-4">
                            <i class="fas fa-clock mr-2"></i><?php echo e($mentorSesiones); ?> sesiones
                        </div>
                        <div class="text-2xl font-bold text-gray-900 mb-6"><?php echo e($mentorPrecio); ?><span class="text-sm font-normal text-gray-600">/hora</span></div>
                        <a href="<?php echo e($mentorUrl); ?>" class="block w-full gradient-primary text-white font-medium py-3 rounded-xl hover:shadow-hover transition-all">
                            Ver perfil
                        </a>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="text-center mt-12">
                <a href="<?php echo e(route('mentor-market.index')); ?>" class="inline-flex items-center btn-primary">
    ...
    <section class="py-20 bg-gradient-to-br from-purple-600 to-indigo-700 text-white">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('register')); ?>" class="bg-white text-purple-600 font-bold px-8 py-4 rounded-xl hover:shadow-hover transition-all flex items-center justify-center">
                    <i class="fas fa-user-graduate mr-3"></i>Empezar a Aprender
                </a>
                <a href="<?php echo e(url('/mentorias/create')); ?>" class="bg-transparent border-2 border-white text-white font-bold px-8 py-4 rounded-xl hover:bg-white/10 transition-all flex items-center justify-center">
