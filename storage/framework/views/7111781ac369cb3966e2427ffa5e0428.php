...
<?php $__env->startSection('header-title', 'Panel administrativo'); ?>
<?php $__env->startSection('header-subtitle', 'Bienvenido de nuevo'); ?>
    ...
    <div class="stats-grid">
        <div class="stat-card">
            <div class="stat-card-content">
                ...
                <p>Cursos activos</p>
                <p><?php echo e(number_format($stats['courses_active'] ?? 0)); ?></p>
            </div>
        </div>
        <div class="stat-card">
            <div class="stat-card-content">
                ...
                <p>S/ <?php echo e(number_format($stats['total_sales'] ?? 0, 2)); ?></p>
            </div>
        </div>
        <div class="stat-card">
            <div class="stat-card-content">
                <div class="stat-icon">👥</div>
                <p>Inscritos</p>
                <p><?php echo e(number_format($stats['total_students'] ?? 0)); ?></p>
            </div>
        </div>
    </div>
            ...
            <div class="list-container">
                <?php $__empty_1 = true; $__currentLoopData = $pendingCourses ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="list-item">
                        ...
                        <a href="<?php echo e(route('admin.courses.show', $course->id)); ?>">Revisar</a>
                    </div>
        ...
        <div class="content-card">
            ...
            <div class="list-container">
                <?php $__empty_1 = true; $__currentLoopData = $recentUsers ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="list-item">
                        <span><?php echo e($user->name); ?> · <?php echo e(ucfirst($user->role ?? 'usuario')); ?></span>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillnest-backend\resources\views/dashboard/admin/index.blade.php ENDPATH**/ ?>