    ...
    <div class="courses-layout py-12">
        <aside class="filters-panel">
            <div class="flex items-center justify-between">
                <h2>Filtros</h2>
                <a href="<?php echo e(route('cursos.index')); ?>" class="text-sm font-semibold" style="color: var(--color-primary);">Limpiar todo</a>
            </div>
            ...
            <form class="space-y-5">
                ...
                <div class="filter-group">
                    ...
                    <?php $__currentLoopData = ['Programación (234)', 'Diseño (156)', 'Marketing (98)']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label>
                            <input type="radio" name="category" <?php echo e($loop->first ? 'checked' : ''); ?>>
                            <?php echo e($category); ?>
                ...
                <div class="filter-group">
                    ...
                    <?php $__currentLoopData = ['Todos', 'Gratis', '< S/ 100', 'S/ 100 - 200']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label>
                            <input type="radio" name="price" <?php echo e($loop->first ? 'checked' : ''); ?>>
                            <?php echo e($price); ?>
                ...
                <div class="filter-group">
                    ...
                    <?php $__currentLoopData = ['Principiante', 'Intermedio', 'Avanzado']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label>
                            <input type="radio" name="level" <?php echo e($loop->first ? 'checked' : ''); ?>>
                            <?php echo e($level); ?>
        ...
        <section class="courses-results">
            <div class="results-topbar">
                <div>
                    ...
                    <h1><?php echo e($totalCursos); ?> cursos encontrados</h1>
                </div>
            ...
            <div class="results-grid">
                <?php $__currentLoopData = $catalog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <article class="course-card">
                        <div style="position: relative;">
                            ...
                            <span class="pill" style="position:absolute; top:16px; left:16px;"><?php echo e($category); ?></span>
                        </div>
                        <div class="card-body">
                            <div>
                                <h3 class="text-xl font-semibold" style="color: var(--color-text);"><?php echo e($title); ?></h3>
                                <p style="color: rgba(51,51,51,0.6); font-size: 0.9rem;"><?php echo e($mentor); ?></p>
                            </div>
                            <p style="color: rgba(51,51,51,0.7); font-size: 0.95rem;"><?php echo e(Str::limit($description, 110)); ?></p>
                            <div class="course-card__meta">
                                <span>⭐ <?php echo e($rating); ?></span>
                                <span>👥 <?php echo e($students); ?></span>
                            </div>
                            <footer>
                                <p class="text-2xl font-bold" style="color: var(--color-text);">S/ <?php echo e($price); ?></p>
            ...
            <div class="pagination">
                ...
                <?php $__currentLoopData = range(1, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button class="<?php echo e($page === 2 ? 'is-active' : ''); ?>"><?php echo e($page); ?></button>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillnest-backend\resources\views/cursos/index.blade.php ENDPATH**/ ?>