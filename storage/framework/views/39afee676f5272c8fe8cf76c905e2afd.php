    ...
    <div class="checkout-page">
        <div class="checkout-wrapper">
            <section class="checkout-payment">
                ...
                <form method="POST"
                      action="<?php echo e(route('mentorias.payment.store', $mentoria->id)); ?>"
                    ...
                    <div class="checkout-methods">
                        <?php $__currentLoopData = $walletMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="checkout-method-card <?php echo e($defaultMetodo === $method ? 'active' : ''); ?>" data-metodo="<?php echo e($method); ?>">
                    ...
                    <?php $__currentLoopData = ['yape', 'plin']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wallet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="checkout-form-section checkout-wallet-form <?php echo e($defaultMetodo === $wallet ? 'active' : ''); ?>" data-wallet="<?php echo e($wallet); ?>">
                            <div class="checkout-wallet-card">
                                <div class="checkout-wallet-number"><?php echo e($walletMethods[$wallet]['number']); ?></div>
                                <p class="checkout-wallet-text">
                                    1. Realiza el pago a este n&#250;mero usando <?php echo e(ucfirst($wallet)); ?><br>
                                ...
                                <div class="checkout-field">
                                    ...
                                    <input type="file" name="comprobante" id="comprobante-<?php echo e($wallet); ?>" class="checkout-input" style="display:none;" accept="image/*">
                                    <label class="checkout-file-button" for="comprobante-<?php echo e($wallet); ?>">
                    ...
                    <div class="checkout-form-section checkout-card-form <?php echo e($metodoEsTarjeta ? 'active' : ''); ?>">
                        <div class="checkout-field">
                            <label class="checkout-label">N&#250;mero de tarjeta</label>
                            <input type="text" name="numero_tarjeta" value="<?php echo e(old('numero_tarjeta')); ?>" class="checkout-input" maxlength="16" placeholder="0000 0000 0000 0000">
                        </div>
                    </div>
            ...
            <aside class="checkout-summary">
                ...
                <div class="summary-course">
                    <h3><?php echo e($mentoria->mentor->name ?? 'Mentor SkillNest'); ?></h3>
                    <p><?php echo e($mentoria->especialidad ?? 'Mentor&#237;a personalizada'); ?></p>
                </div>

                <div>
                    <div class="summary-price-row">
                        <span class="price-label">Monto de la mentor&#237;a</span>
                        <span class="price-value">S/ <?php echo e(number_format($monto, 2)); ?></span>
                    </div>
                    <div class="summary-price-row">
                    ...
                    <div class="summary-price-row total">
                        ...
                        <span class="summary-total-value">S/ <?php echo e(number_format($monto, 2)); ?></span>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\skillnest-backend\resources\views/payments/pay.blade.php ENDPATH**/ ?>