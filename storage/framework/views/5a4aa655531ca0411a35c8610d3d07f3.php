    ...
    <header class="dashboard-hero editor-hero">
        ...
        <div class="dashboard-hero__content">
            ...
            <div class="dashboard-hero__meta">
                <div>
                    <p class="font-semibold text-slate-800"><?php echo e(auth()->user()->name); ?></p>
        ...
        <div class="editor-actions-bar">
            ...
            <div class="editor-actions-buttons">
                ...
                <a href="<?php echo e(route('cursos.show', $curso->id)); ?>" class="btn-secondary">
                    <i class="fas fa-eye"></i> Vista Previa
                </a>
                
                <form method="POST" action="<?php echo e(route('cursos.send-to-review', $curso->id)); ?>">
                    <?php echo csrf_field(); ?>
...
<?php $__env->startSection('dashboard-content'); ?>
    ...
    <div class="editor-wrapper">
        ...
        <div id="course-editor"
             ...
             data-basics-endpoint="<?php echo e(route('cursos.update-basics', $curso->id)); ?>"
             data-order-endpoint="<?php echo e(route('cursos.order', $curso->id)); ?>"
             data-image-endpoint="<?php echo e(route('cursos.update-image', $curso->id)); ?>"
             class="editor-layout">
