...
<?php $__env->startSection('mentor-subtitle', 'Actualiza tu historia profesional y tus tarifas'); ?>
...
<?php $__env->startSection('mentor-content'); ?>
    <div class="mentor-profile-layout">
        <form action="<?php echo e(route('mentor.profile.update')); ?>" method="POST" enctype="multipart/form-data" class="mentor-profile-form">
            <?php echo csrf_field(); ?>
            <input type="file" id="avatar-input" name="avatar" accept="image/*" style="display:none;">

            <section class="mentor-profile-hero">
                <div>
                    <p class="mentor-label">Hola, <?php echo e($user->name); ?></p>
                    ...
                    <div class="mentor-profile-meta">
                        <div>
                            ...
                            <span class="mentor-meta-value"><?php echo e($currentRole ?: 'Mentor SkillNest'); ?></span>
                        </div>
                        <div>
                            <span class="mentor-meta-label">Experiencia</span>
                            <span class="mentor-meta-value"><?php echo e($experienceYears); ?> a&ntilde;os</span>
                        </div>
                        <div>
                            <span class="mentor-meta-label">Tarifa</span>
                            <span class="mentor-meta-value">S/ <?php echo e($formattedRate); ?></span>
                        </div>
                    </div>
                </div>
                <div class="mentor-profile-upload">
                    <img src="<?php echo e($avatar); ?>" alt="Avatar" class="mentor-avatar-preview">
                ...
                <div class="mentor-card soft">
                    ...
                    <div class="mentor-form-grid">
                        <div class="mentor-form-field">
                            ...
                            <input id="name" class="mentor-input" type="text" name="name" value="<?php echo e(old('name', $user->name)); ?>" required>
                        </div>
                        <div class="mentor-form-field">
                            <label for="profesion">Profesi&oacute;n</label>
                            <input id="profesion" class="mentor-input" type="text" name="profesion" value="<?php echo e(old('profesion', $profile->profesion ?? '')); ?>" placeholder="Product Designer, Frontend Lead">
                        </div>
                        <div class="mentor-form-field full">
                            <label for="descripcion">Descripci&oacute;n</label>
                            <textarea id="descripcion" name="descripcion" class="mentor-input" rows="4" placeholder="Cu&eacute;ntales a los estudiantes sobre tu experiencia y logros."><?php echo e(old('descripcion', $profile->descripcion ?? '')); ?></textarea>
                        </div>
                        <div class="mentor-form-field">
                            <label for="skills">Habilidades</label>
                            <input id="skills" class="mentor-input" type="text" name="skills" value="<?php echo e($skillValue); ?>" placeholder="React, UX/UI, Data Viz">
                            <p class="mentor-hint">Separa cada habilidad con comas.</p>
                        </div>
                        <div class="mentor-form-field">
                            <label for="categorias">Categor&iacute;as</label>
                            <input id="categorias" class="mentor-input" type="text" name="categorias" value="<?php echo e($categoryValue); ?>" placeholder="Frontend, UX/UI">
                ...
                <div class="mentor-card soft">
                    ...
                    <div class="mentor-form-grid">
                        <div class="mentor-form-field">
                            ...
                            <input id="experiencia_anios" class="mentor-input" type="number" min="0" name="experiencia_anios" value="<?php echo e($experienceYears); ?>">
                        </div>
                        <div class="mentor-form-field">
                            <label for="precio_hora">Precio por hora (S/)</label>
                            <input id="precio_hora" class="mentor-input" type="number" step="0.1" min="0" name="precio_hora" value="<?php echo e($hourlyRate); ?>">
                        </div>
                        <div class="mentor-form-field">
                            ...
                            <select id="nivel_experiencia" name="nivel_experiencia" class="mentor-input">
                                ...
                                <?php $__currentLoopData = $experienceOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value); ?>" <?php if(old('nivel_experiencia', $profile->nivel_experiencia ?? '') === $value): echo 'selected'; endif; ?>><?php echo $label; ?></option>
...
<?php echo $__env->make('layouts.mentor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\NADHIRA\Downloads\SkillNest\resources\views/dashboard/mentor/profile.blade.php ENDPATH**/ ?>